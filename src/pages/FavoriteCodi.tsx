...
const favoriteCodiItems: FavoriteCodiItems[] = [
  {
    id: 1,
    image: item_sample,
    category: "데일리",
...
function FavoriteCodi() {
  ...
  const filteredItems = favoriteCodiItems.filter((item: FavoriteCodiItems) => {
          ...
          <div className="flex flex-col gap-3">
            <div className="flex gap-3">
              <Autocomplete
                ...
                options={favoriteCodiItems.map((item) => item.title)}
                sx={{
                  width: "100%",
                }}
                renderInput={(params) => (
